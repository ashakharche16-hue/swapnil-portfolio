...
// Path data extracted from the reference SVGs (lucide-style, 24x24 stroke).
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  // Brand mark — rendered filled (see FILLED set below).
  linkedin: (
...
const FILLED = new Set<IconName>(["linkedin"]);
